...
void _ui_init_default_Ungroup_0() {
    ...
    ui_default_Ungroup_0.option.start_x = 288;
    ui_default_Ungroup_0.option.start_y = 670;
    ui_default_Ungroup_0.option.color = 3;
    ui_default_Ungroup_0.option.str_length = 4;
    ui_default_Ungroup_0.option.width = 5;
    strcpy(ui_default_Ungroup_NewText->string, "Text");
